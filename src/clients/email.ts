...
export class EmailClient {
  ...
  constructor() {
    this.ses = new SESClient({ region: 'ap-southeast-1' });
  }
...
<div style="font-family: Arial, sans-serif; max-width: 700px; margin: 0 auto;">
  ...
  <div style="border: 1px solid #ddd; border-top: none; padding: 20px; border-radius: 0 0 8px 8px;">
    ...
    <p style="color: #999; font-size: 12px;">Generated by BLUE.Y — BlueOnion AI Ops Assistant<br>Cluster: blo-cluster | Region: ap-southeast-1</p>
  </div>
</div>`;
